...
path = "/tmp/nox_hardening/app/src/main/java/com/noxscreen/app/BlackScreenService.kt"
...
replacement1 = """    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        val prefs = getSharedPreferences("NoxAutomationPrefs", Context.MODE_PRIVATE)
